...
checkpoint_path = 'models/mobilenetv2_model.h5'
...
def plot_training(history):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('models/mobilenetv2_training_curves.png')
    plt.show()

plot_training(history)

with open('models/mobilenetv2_training_history.pkl', 'wb') as f:
